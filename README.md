...
- **動態 App Logo**  
  DarknessWeb 的應用程式圖示會根據目前瀏覽的網頁 Favicon 自動變更，提升互動感與沉浸感

- **基於 WebView2 技術**  
  採用 Microsoft WebView2，使用 Chromium 引擎的高速渲染與現代網頁兼容性。

## 概述

DarknessWeb 並非要取代主力瀏覽器，而是針對特定情境提供合適的解決辦法：
...
> 💡 *DarknessWeb 專為創作者、直播主、簡報者打造的工具。  
